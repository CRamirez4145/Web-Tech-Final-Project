...
public class PeerEvaluationService {
    ...
    public PeerEvaluationResponse createPeerEvaluation(Long evaluatorId, CreatePeerEvaluationRequest request) {
        ...
        if ((evaluator.getRole() != null && evaluator.getRole() != UserRole.STUDENT)
                || (evaluatee.getRole() != null && evaluatee.getRole() != UserRole.STUDENT)) {
            throw new BusinessRuleException("Peer evaluations can only be submitted between student users.");
        }
    ...
    private void validatePeerEvaluationRequest(User evaluator,
        ...
        if (evaluator.getTeam() == null || evaluator.getSection() == null
                || evaluatee.getTeam() == null || evaluatee.getSection() == null) {
            throw new BusinessRuleException("Both students must be assigned to the same section and team before submitting a peer evaluation.");
        }
