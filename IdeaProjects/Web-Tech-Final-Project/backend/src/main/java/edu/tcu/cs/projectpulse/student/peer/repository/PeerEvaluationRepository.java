...
public interface PeerEvaluationRepository extends JpaRepository<PeerEvaluation, Long> {
    ...
    @EntityGraph(attributePaths = {
            "evaluator", "evaluatee", "team", "section", "activeWeek", "rubric",
            "criterionScores", "criterionScores.criterion"
    })
    List<PeerEvaluation> findBySectionIdOrderBySubmittedAtDesc(Long sectionId);

    @EntityGraph(attributePaths = {
            "evaluator", "evaluatee", "team", "section", "activeWeek", "rubric",
            "criterionScores", "criterionScores.criterion"
    })
    List<PeerEvaluation> findAllByOrderBySubmittedAtDesc();
}
